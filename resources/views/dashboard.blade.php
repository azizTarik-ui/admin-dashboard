        ...
        <div class="mt-2">
            ...
            <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    ...
                    <div class="relative p-4 h-72">
                        ...
                        <canvas id="barChart" width="1030" height="256"
                            style="display: block; width: 1030px; height: 256px;"
                ...
                <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    ...
                    <div class="relative p-4 h-72">
                        ...
                        <canvas id="doughnutChart" width="483" height="256"
                            style="display: block; width: 483px; height: 256px;"
                            class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                ...
                <div class="col-span-1 bg-white rounded-md dark:bg-darker">
                    ...
                    <p class="p-4">
                        <span class="text-2xl font-medium text-gray-500 dark:text-light" id="usersCount">31</span>
                    ...
                    <div class="relative p-4">
                        ...
                        <canvas id="activeUsersChart" width="483" height="150"
                            style="display: block; width: 483px; height: 150px;"
                            class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                    ...
                    <div class="relative p-4 h-72">
                        ...
                        <canvas id="lineChart" width="1030" height="256"
                            style="display: block; width: 1030px; height: 256px;"
                            class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
